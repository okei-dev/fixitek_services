...
const QuoteCard: React.FC<QuoteCardProps> = ({ children }) => {
    return (
        <div className="absolute mx-4 -top-20 flex flex-col justify-center py-10 px-8 rounded-2xl bg-[var(--accent--primary-1)]">
